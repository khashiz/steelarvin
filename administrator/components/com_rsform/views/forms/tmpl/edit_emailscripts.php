...
<?php echo RSFormProHelper::showEditor('UserEmailScript', $this->form->UserEmailScript, array('classes' => 'rs_100', 'syntax' => 'php')); ?>
...
<?php echo RSFormProHelper::showEditor('AdminEmailScript', $this->form->AdminEmailScript, array('classes' => 'rs_100', 'syntax' => 'php')); ?>
...
<?php echo RSFormProHelper::showEditor('AdditionalEmailsScript', $this->form->AdditionalEmailsScript, array('classes' => 'rs_100', 'syntax' => 'php')); ?>