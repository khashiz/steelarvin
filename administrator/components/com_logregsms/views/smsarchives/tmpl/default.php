...
<form action="index.php?option=com_logregsms&view=smsarchives" method="post" name="adminForm" id="adminForm">
   ...
   <div class="filter-search fltlft">
			...
			<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('Search'); ?>" placeholder="جستجو ..." />
...
<br>
    ...
    <table style="width:1500px;" id="smsarchivesList" class="table table-striped table-bordered table-hover table-condensed">
        <thead>
        	<tr>
