...
?>
<span class="uk-text-bold uk-text-small uk-text-secondary font">{address_title}</span><span class="uk-display-block uk-text-small uk-text-muted font">{address_state} ، {address_city} ، {address_street} ، <?php echo JText::sprintf('HIKA_ADDRESS_PELAK');?> {address_pelak}<?php if(!empty($this->address->address_vahed)) echo JText::sprintf('HIKA_ADDRESS_VAHED','{address_vahed}');?>
