...
<div class="uk-flex uk-flex-middle uk-height-1-1 search<?php echo $moduleclass_sfx; ?>">
    <a href="#" class="uk-text-gray hoverAccent transition"><img src="<?php echo JURI::base().'images/sprite.svg#search' ?>" width="18" height="18" data-uk-svg></a>
	<form action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-inline uk-hidden" role="search">
		<?php
