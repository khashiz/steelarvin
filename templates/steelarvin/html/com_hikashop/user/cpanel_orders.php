            ...
            <?php foreach($this->cpanel_data->cpanel_orders as $order_id => $order) { ?>
                ...
                <div>
                    <div class="uk-position-relative">
                                        ...
                                        <div class="uk-width-auto uk-flex uk-flex-middle">
                                            <div>
                                                <div class="uk-grid-small uk-child-width-auto uk-grid-divider" data-uk-grid>
                                                    ...
                                                    <div>
                                                        <span class="uk-text-small uk-text-<?php echo $order->order_status; ?> font myOrderMetaItem status"><?php echo hikashop_orderStatus($order->order_status); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div>
                            <span class="uk-display-block uk-text-tiny uk-text-muted uk-margin-small-bottom font"><?php echo JText::sprintf('ORDERITEMS'); ?></span>
                            <div>
                                ...
                                foreach($order->products as $product) {
                                    ...
                                    <div>
                                        ...
                                        if(!empty($this->cpanel_data->cpanel_order_image)) {
                                            $img = $this->imageHelper->getThumbnail(@$product->images[0]->file_path, array(100, 100), array('default' => true, 'forcesize' => true,  'scale' => 'outside'));
                                            if(!empty($img) && $img->success) {
                                                ?>
                                                <a class="hika_cpanel_product_image_link uk-display-inline-block uk-border-rounded uk-overflow-hidden uk-box-shadow-small" href="<?php echo $link; ?>"><img class="hika_cpanel_product_image" src="<?php echo $img->url; ?>" alt="" /></a>
                                                <?php
                                            }
                                        }
                                        ?>
                                        <a href="<?php echo $link; ?>" class="uk-hidden">
                                        ...
                                        <p class="hika_cpanel_product_price uk-hidden">
                                        <span class="hika_cpanel_product_price_quantity">
                                            <?php echo  $product->order_product_quantity; ?>
                                        </span>
                                            <span class="hika_cpanel_product_price_times"> x </span>
