...
<div class="uk-card uk-card-default uk-border-rounded uk-overflow-hidden uk-box-shadow-small">
    <div class="uk-padding item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
        ...
        <?php if ($params->get('show_title')) : ?>
            <div class="page-header">
                <h2 itemprop="headline" class="uk-margin-bottom uk-text-accent uk-text-bold uk-h4 font">
        ...
        <?php if ($params->get('access-view')) : ?>
            ...
            <div itemprop="articleBody" class="uk-text-justify uk-text-small font">
