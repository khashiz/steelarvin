...
$isUnpublished = ($this->item->state == 0 || $this->item->publish_up > $currentDate) || ($this->item->publish_down < $currentDate && $this->item->publish_down !== JFactory::getDbo()->getNullDate());
...
<div class="uk-accordion-content uk-text-justify uk-text-small uk-padding-small uk-padding-remove-vertical font">
    ...
    <?php if ($params->get('show_readmore') && $this->item->readmore) :
        ...
        <?php echo JLayoutHelper::render('joomla.content.sa_readmore', array('item' => $this->item, 'params' => $params, 'link' => $link)); ?>
